...
const clerkAnimations = new Map([
  ["clerk-beauty-01", { frames: [1, 2, 3, 4], tileIds: [0, 5, 6, 7] }],
  ["clerk-liquor-food-01", { frames: [5, 6, 7, 8], tileIds: [1, 8, 9, 10] }],
  ["clerk-gift-01", { frames: [9, 10, 11, 12], tileIds: [2, 11, 12, 13] }]
]);
npcs.tiles = npcs.tiles.filter((tile) => tile.id < 5);
