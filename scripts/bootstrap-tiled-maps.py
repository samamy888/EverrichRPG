...
PROPS = [
    ...
    ("airport-queue-barriers", "airport-facilities-v3/queue-barriers.png"),
...
def build_tilesets() -> None:
    ...
    write_json(
        TILESETS_DIR / "airport-props.tsj",
        {
            ...
            "tiledversion": "1.11.2",
            "name": "airport-props",
            "tilewidth": max(tile["imagewidth"] for tile in prop_tiles),
            "tileheight": max(tile["imageheight"] for tile in prop_tiles),
    ...
    write_json(
        TILESETS_DIR / "airport-npcs.tsj",
        {
            ...
            "tiledversion": "1.11.2",
            "name": "airport-npcs",
            "tilewidth": max(tile["imagewidth"] for tile in npc_tiles),
            "tileheight": max(tile["imageheight"] for tile in npc_tiles),
