...
public sealed class ShopCatalogEndpointsTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient client;

    public ShopCatalogEndpointsTests(WebApplicationFactory<Program> factory)
    {
